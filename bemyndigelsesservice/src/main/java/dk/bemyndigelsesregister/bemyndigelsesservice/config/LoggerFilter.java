    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            final StringBuilder logMessage = new StringBuilder(
                    "[HTTP METHOD:").append(httpServletRequest.getMethod()).append("]")
            ...
            logger.info("[REQUEST BODY:" + bufferedRequest.getRequestBody() + "]");

            chain.doFilter(bufferedRequest, bufferedResponse);

            logger.info(" [RESPONSE BODY:" + bufferedResponse.getContent() + "]");
        } catch (Throwable a) {
