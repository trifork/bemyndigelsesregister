...
//        doExport(startTime, bemyndigelseDao.findBySidstModificeretGreaterThanOrEquals(lastRun.getDateTimeValue())); TODO: OBJ implement with new BEM2 service
...
/*  TODO: OBJ implement with new BEM2 service
        SystemVariable lastRun = systemVariableDao.getByName("lastRun");
        final DateTime startTime = systemService.getDateTime();
        try {
