...
@Repository
public class ServiceTypeMapperImpl_20170801 implements ServiceTypeMapper_20170801 {
    @Inject
    RoleDao roleDao;
    ...
    private SystemPermission toPermission(String delegatingSystemCode, DelegationPermission permission) {
    ...
    private dk.nsi.bemyndigelse._2017._08._01.DelegatingSystem toSystem(String delegatingSystemCode) {
        DelegatingSystem ds = getDelegatingSystem(delegatingSystemCode);
        if (ds == null)
            return null;
    ...
    private dk.nsi.bemyndigelse._2017._08._01.DelegatingRole toRole(String delegatingSystemCode, String roleCode) {
