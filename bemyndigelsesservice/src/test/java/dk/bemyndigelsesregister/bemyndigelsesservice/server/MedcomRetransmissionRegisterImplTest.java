...
public class MedcomRetransmissionRegisterImplTest {
    private final MessageRetransmissionDao messageRetransmissionDao = mock(MessageRetransmissionDao.class);
    private final MedcomRetransmissionRegisterImpl register = new MedcomRetransmissionRegisterImpl();
    ...
    public void willReturnMappedMedcomReplay() throws Exception {
        ...
        MedcomRetransmission medcomRetransmission = register.getReplay(messageID);

        assertEquals(messageID, medcomRetransmission.getMessageId());
        assertEquals(unmarshalledObject, medcomRetransmission.getResponseMessage());
    }
