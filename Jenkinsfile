		...
		stage('build') {
			steps {
				script {
					...
					withDockerNetwork { n ->
							docker.image("registry.fmk.netic.dk/fmk/fmkbuilder:8").inside(containerUserMapping + "--network ${n} --add-host ci.fmk.netic.dk:2a03:dc80:0:f12d::118 --add-host registry.fmk.netic.dk:2a03:dc80:0:f12d::118 --add-host f.aia.systemtest19.trust2408.com:2a03:dc80:0:f12d::120 --add-host f.aia.ica02.trust2408.com:2a03:dc80:0:f12d::120 --add-host registry.npmjs.org:2606:4700::6810:1923 --add-host nodejs.org:2606:4700:10::6814:162e --add-host registry.bower.io:2400:cb00:2048:1::6818:69ac --add-host github.com:64:ff9b::8c52:7603 --add-host github-production-release-asset-2e65be.s3.amazonaws.com:64:ff9b::34d8:ab93 -e _JAVA_OPTIONS='-Dfile.encoding=UTF-8 -Djava.net.preferIPv4Stack=false -Djava.net.preferIPv6Stack=true -Djava.net.preferIPv6Addresses=true' -e GIT_COMMIT=$GIT_COMMIT -e GIT_BRANCH=$GIT_BRANCH -v /var/run/docker.sock:/var/run/docker.sock") {
