...
public class Delegations {
    ...
    public void addDelegation(String uuid, String delegatorCpr, String delegateeCpr, String delegateeCvr, String system, String status, String role, String permission, Instant approvalDate, Instant modifiedDate, Instant effectiveFrom, Instant effectiveTo) {
        if (delegations == null)
